 ...
 */
function vzo__display_scaffolding_section( $args = [] ) {
	// Set defaults.
	$defaults = [
	...
	$allowed_tags = vzo__scaffolding_allowed_html();
	...
	<div class="scaffolding-document accordion <?php echo esc_attr( $class ); ?>">
		...
		<div class="accordion-item">
			...
			<header class="scaffolding-document-header display-flex flex-start space-between accordion-item-header">
				...
				<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'viezo' ); ?></button>
			...
			<div class="scaffolding-document-content accordion-item-content">
				...
				<?php if ( $args['description'] ) : ?>
					<p><strong><?php esc_html_e( 'Description', 'viezo' ); ?>:</strong></p>
					<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
				<?php endif; ?>

				<?php if ( $args['parameters'] ) : ?>
					<p><strong><?php esc_html_e( 'Parameters', 'viezo' ); ?>:</strong></p>
				...
				<?php if ( $args['arguments'] ) : ?>
					<p><strong><?php esc_html_e( 'Arguments', 'viezo' ); ?>:</strong></p>
				...
				<?php if ( $args['usage'] ) : ?>
					<p><strong><?php esc_html_e( 'Usage', 'viezo' ); ?>:</strong></p>
					<pre><?php echo esc_html( $args['usage'] ); ?></pre>
				<?php endif; ?>

				<?php if ( $args['output'] ) : ?>
					<p><strong><?php esc_html_e( 'HTML Output', 'viezo' ); ?>:</strong></p>
 ...
 */
function vzo__scaffolding_allowed_html() {
 ...
 */
function vzo__display_global_scaffolding_section( $args = [] ) {
	// Set defaults.
	$defaults = [
 ...
 * @author Carrie Forde
 */
function vzo__hook_theme_scaffolding() {
...
add_action( 'vzo__scaffolding_content', 'vzo__hook_theme_scaffolding' );
