 				...
 				<div class="relative h-screen py-48">
 					...
 					<div
 						...
 						<div
 							...
 							<p class="desktop:text-lg font-hiragino-sans">No contextual information about the equipment
 								is
 						...
 						<div
 							...
 							<p class="desktop:text-lg font-hiragino-sans">Plan your repair work at a convenient time
 								when
 						...
 						<div
 							...
 							<p class="desktop:text-lg font-hiragino-sans">The system informs you about real impending
 								faults,
 						...
 						<div
 							...
 							<p class="desktop:text-lg font-hiragino-sans">Thanks to favourable pricing, the return on
