...
">
 					<div
 						...
 						<div
 							...
 							<p class="text-[16px] font-hiragino-sans">No contextual information about
 								the equipment
 								is
 						...
 						<div
 							...
 							<p class="text-[16px] font-hiragino-sans">Plan your repair work at a
 								convenient time
 								when
 						...
 						<div
 							...
 							<p class="text-[16px] font-hiragino-sans">The system informs you about real
 								impending
 								faults,
 						...
 						<div
 							...
 							<p class="text-[16px] font-hiragino-sans">Thanks to favourable pricing, the
 								return on
 	...
 	<div
 		class="text-center mt-32 flex gap-12 px-8 md:px-0 items-center py-28 border-t border-white justify-center font-body-1">
 		<p class="text-white mb-0">Need more information?</p>
 		<a href="/contact-us" class="button outline-white">
 			Contact Us
 		</a>
 	</div>
 </div>
