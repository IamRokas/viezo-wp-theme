...
<div class="container py-64 desktop:py-104">
    <h2 class=" pb-40 font-osp-din uppercase"><?= $title; ?></h2>
    <div class="blocks-grid grid grid-cols-2 desktop:grid-cols-3 desktop:gap-24 gap-12">
        ...
        <div class="<?= $block_classes; ?>">
            ...
            <div class="block-content">
                <?php if ($title) : ?>
                <h3 class="pb-30 mt-12 desktop:mt-20 font-osp-din text-base desktop:text-lg uppercase text-black">
                    <?= $title; ?></h3>
                <?php endif; ?>
            </div>
        </div>
